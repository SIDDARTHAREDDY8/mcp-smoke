...
# timeouts: --timeout is the global default; any phase can be overridden
mcp-smoke --cmd "python server.py" --timeout 30 --call-timeout 60
```
...
136 tests, including deliberately-broken fixture servers (stdout polluter, instant crasher, hanging server, bad schemas, erroring tool, malformed handshakes) and a fixture HTTP server.
